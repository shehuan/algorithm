 ...
 */
public class NotRepeatLongestSubString0 {
    public int lengthOfLongestSubString(String s) {
        ...
        for (; i < s.length(); i++) {
            ...
            counts[s.charAt(i)]++;
            // 当某个字符出现次数大于1，该子串有了重复字符，需要开始向右移动第一个指针j，
    ...
    public static void main(String[] args) {
        int result = new NotRepeatLongestSubString0().lengthOfLongestSubString("babcdefca");
